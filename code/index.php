    ...
    if (isset($_SESSION["nick"])) {
        if($_SESSION["nick"] == "Admin") {
            if (isset($_POST['DeleteEvent'])) {
                ...
                mysql_query("DELETE FROM `Support` WHERE EventId = \"$EventId\"");
                mysql_query("DELETE FROM `Opposition` WHERE EventId = \"$EventId\"");
                mysql_query("DELETE FROM `Participation` WHERE EventId = \"$EventId\"");
