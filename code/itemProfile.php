...
<html>
    <head>
        <?php
            ...
            $design->createHeader("Item", "css/web_tech.css");
        ?>
    </head>
    ...
    <body>
        ...
        // delete event, report event, add event to watchlist button, checks rights
        if(isset($_SESSION["nick"])) {
            if($_SESSION["nick"] == "Admin") {
                echo"
				...
				echo "<input type='button' onclick='window.location.href=\"watchlistEvent.php?id=$EventId\"' value='Watchlist' name='Watchlist' /><br><br>";
        }
        else
            echo "<input type='button' onclick='window.location.href=\"reportEvent.php?id=$EventId\"' value='Report Event' name='report' /><br><br>";
